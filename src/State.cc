 ...
 */
void State::set_all_transitions (unsigned int n_transition, std::set <Transition>& transitions) {
...
void State::Write (void) const {
  ...
  std::cout << "Identificador: " << name_ << "\n";
  std::cout << "Identificador numerico: "<< ID_ << "\n";
  std::cout << "Numero de transiciones: " << transition_num_ << "\n";
